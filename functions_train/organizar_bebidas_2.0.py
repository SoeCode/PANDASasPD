#trabalhando com novos parametros para potencializar o uso da função.
...
def cod_da_categoria(bebida, cod_produto):
    bebida = bebida.upper()
...
for produto in produtos:
    if cod_da_categoria(produto, 'BEB'):
        print(f' Enviar {produto} para o setor de bebidas alcóolicas.')
    elif cod_da_categoria(bebida = produto, cod_produto = 'CAR'):
        print(f' Enviar {produto} para o setor de bebidas importadas.')

#podendo continuar percorrendo a lista usando os argumentos da função
